...
degree_in_static = Metrics(Metrics.DEGREE, c_in, static)
weighted_degree_in_static = Metrics(Metrics.WEIGHTED_DEGREE, c_in, static)
degree_centrality_in_static = Metrics(Metrics.DEGREE_CENTRALITY, c_in, static)
eigenvector_centrality_in_static = Metrics(Metrics.EIGENVECTOR_CENTRALITY, c_in, static)
weighted_eigenvector_centrality_in_static = Metrics(Metrics.WEIGHTED_EIGENVECTOR_CENTRALITY, c_in, static)
katz_centrality_in_static = Metrics(Metrics.KATZ_CENTRALITY, c_in, static)
weighted_katz_centrality_in_static = Metrics(Metrics.WEIGHTED_EIGENVECTOR_CENTRALITY, c_in, static)

degree_in_dynamic = Metrics(Metrics.DEGREE, c_in, dynamic)
weighted_degree_in_dynamic = Metrics(Metrics.WEIGHTED_DEGREE, c_in, dynamic)
degree_centrality_in_dynamic = Metrics(Metrics.DEGREE_CENTRALITY, c_in, dynamic)
eigenvector_centrality_in_dynamic = Metrics(Metrics.EIGENVECTOR_CENTRALITY, c_in, dynamic)
weighted_eigenvector_centrality_in_dynamic = Metrics(Metrics.WEIGHTED_EIGENVECTOR_CENTRALITY, c_in, dynamic)
katz_centrality_in_dynamic = Metrics(Metrics.KATZ_CENTRALITY, c_in, dynamic)
weighted_katz_centrality_in_dynamic = Metrics(Metrics.WEIGHTED_EIGENVECTOR_CENTRALITY, c_in, dynamic)
...
for mode in modes_to_calculate:
    for value in values_to_calculate:
        manager.new_calculate(mode=mode,
                              save_to_file=False,
                              calculate_histogram=False,
                              predict=False,
                              metrics=value,
